...
<body>
	<div class="container">
		...
		<table class="table">
			...
			<!--  글쓰기 버튼  -->
			<tr>
				<td colspan="5"><a href="writeForm실습.jsp"><button>글쓰기</button></a>
				</td>
				<td colspan="5"><a href="updateForm.jsp"><button>글수정</button></a>
				</td>
				<td colspan="5"><a href="delete.jsp"><button>글삭제</button></a></td>
			</tr>
		</table>
	</div>
</body>
