...
//				 System.out.println("메뉴의 번호를 입력하세요.");
				 ...
				 switch (menu) {
				 case "1":
					 System.out.println("1. 질문답변 리스트 처리");
					 ...
					 break;
				 case "2":
					 System.out.println("2. 질문답변  보기 처리");
...
//					 System.out.println("보여줄 글번호를 입력하세요");
					 ...
					 break;
				 case "3":
					 System.out.println("3. 질문답변 질문하기 처리 ");
...
//					 String writeId = "admin"; // 강제 로그인
				 ...
				 case "4":
					 ...
					 System.out.println("4. 질문답변 답변하기 처리");
...
//					 inDTO.setId(answerId);
				 ...
				 case "5":
					 ...
					 System.out.println("5. 질문답변 수정 처리 ");
...
//					 throw new NotLoginException();
				 ...
				 case "6":
					 ...
					 System.out.println("6. 질문답변 삭제 처리 ");
...
//					Output.loginInfor();
	...
	public int IdNoCheck(QnaDTO dto) throws Exception{
		QnaUpdateService QnaUpdateService = new QnaUpdateService();
		if(QnaUpdateService.idCheck(dto) == false) {
