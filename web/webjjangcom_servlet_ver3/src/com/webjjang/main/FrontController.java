...
//static 메서드 인경우 static import를 사용해서 메서드 까지 지정을 해놓으면 메서드만 사용할 수 있다. 
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			if(uri.indexOf("/board") == 0) {
				...
				//ajax인 경우 주 로 jsp를 만들지 않고 데이터를 그대로 보낸다.
			...
			// 처리가 다 끝나면 jsp로 forward 할지 url로 redirect할지를 처리하는 문을 작성
