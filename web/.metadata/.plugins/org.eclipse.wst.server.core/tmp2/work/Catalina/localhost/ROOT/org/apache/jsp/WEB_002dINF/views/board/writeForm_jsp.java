 ...
 * Generated at: 2019-12-04 07:05:02 UTC
...
public final class writeForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function () {\r\n");
      out.write("\t//js 패턴 객체\r\n");
      out.write("// \t title_RegEx = /^.{4,100}$/;\r\n");
      out.write("// \t content_RegEx = /^.{5,1000}$/;\r\n");
      out.write("// \t writer_RegEx =/^.{2,10}$/;\r\n");
      out.write("\t\r\n");
      out.write("// \t// writeForm안에 데이터가 넘어 갈때(submit) 데이터 testing\r\n");
      out.write("\t$(\"#writeForm\").submit(function () {\r\n");
      out.write("// // \t\talert(\"데이터가 넘어가기전 확인 함수.\");\r\n");
      out.write("// \t\t//title 체크\r\n");
      out.write("// \t\t//앞뒤 공백 제거 trim()\r\n");
      out.write("// \t\t$(\"#title\").val($(\"#title\").val().trim());\r\n");
      out.write("// // \t\talert(\"[\" + $(\"#title\").val()+\"]\");\r\n");
      out.write("// \t\tif(!title_RegEx.test($(\"#title\").val())){\r\n");
      out.write("// \t\t\t//경고창을 띄운다.\r\n");
      out.write("// \t\t\talert(\"제목은 4글자 이상 100글자 이내로 작성하셔야 합니다.\");\r\n");
      out.write("// \t\t\t// 다시 제목을 입력 할 수 있도록 제목 입력란에 커서를 위치 시킨다. \r\n");
      out.write("// \t\t\t$(\"#title\").focus();\r\n");
      out.write("// \t\t\treturn false;\r\n");
      out.write("// \t\t}\r\n");
      out.write("// \t\t//content 체크\r\n");
      out.write("// \t\t//앞뒤 공백 제거 trim()\r\n");
      out.write("// \t\t$(\"#content\").val($(\"#content\").val().trim());\r\n");
      out.write("// \t\tif(!content_RegEx.test($(\"#content\").val())){\r\n");
      out.write("// \t\t\t//경고창을 띄운다.\r\n");
      out.write("// \t\t\talert(\"제목은 4글자 이상 1000글자 이내로 작성하셔야 합니다.\");\r\n");
      out.write("// \t\t\t// 다시 제목을 입력 할 수 있도록 제목 입력란에 커서를 위치 시킨다. \r\n");
      ...
      out.write("// \t\t//writer 체크\r\n");
      out.write("// \t\t//앞뒤 공백 제거 trim()\r\n");
      out.write("// \t\t$(\"#writer\").val($(\"#writer\").val().trim());\r\n");
      out.write("// \t\tif(!writer_RegEx.test($(\"#writer\").val())){\r\n");
      out.write("// \t\t\t//경고창을 띄운다.\r\n");
      out.write("// \t\t\talert(\"작성자는 2글자 이상 10글자 이내로 작성하셔야 합니다.\");\r\n");
      out.write("// \t\t\t// 다시 제목을 입력 할 수 있도록 제목 입력란에 커서를 위치 시킨다. \r\n");
      ...
      out.write("<!--         \t   name=\"writer\" required=\"required\" pattern=\"^.{2,10}$\" -->\r\n");
      out.write("<!--         \t\ttitle= \"작성자은 4~10글자 사이로  입력하셔야 합니다.\"> -->\r\n");
      out.write("        <input type=\"text\" class=\"form-control\" id=\"writer\" \r\n");
      out.write("        \t   name=\"writer\" title= \"작성자은 4~10글자 사이로  입력하셔야 합니다.\">\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("        <button type=\"submit\"class=\"btn btn-default\">게시판 등록하기</button>\r\n");
      out.write("        <button type=\"reset\">다시입력</button>\r\n");
      out.write("        <button onclick = \"history.back()\">게시판 등록 취소하기</button>\r\n");
      out.write("  </form>\r\n");
      out.write("  </div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
