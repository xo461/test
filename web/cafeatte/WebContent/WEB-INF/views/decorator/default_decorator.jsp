...
<%-- 					<a class="navbar-brand" href="${absUri }">Logo</a> --%>
					<a class="navbar-brand" href="/main.do"><img src="/upload/image/cafeatte_logo.png"/></a>
				</div>
				<!-- 				모듈메뉴 -->
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<!-- 로그인은 한 경우의 메뉴 -->
						<c:if test="${!empty login }">
							<li id="welcome"><a><img src="${login.photo }" style="width: 13%;"
								 class="img-circle">${login.nickName}[${login.gradeName }]</a></li>
