...
public class Beans extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		controllers.put("mainController", new MainController(services.get("cafeHTagListService"), services.get("cafeListService"),
				services.get("magazinemListService"), services.get("userCafeListService")));
